	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				...
				<p class="card-text">강의가 많이 널널해서 , 솔직히 많이 배운 건 없지만 학점도 잘 나오고 너무
					좋은 것 같습니다.</p>
				<div class="row">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 유익한 강의에요.&nbsp;<small>(2017년 가을학기)</small>
				</h5>
				<p class="card-text">강의를 듣고 실력이 향상되었습니다.
					좋은 것 같습니다.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span> 널널<span style="color: red;">A</span>
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 최고의 강의에요.&nbsp;<small>(2017년 가을학기)</small>
				</h5>
				<p class="card-text">강의가 다양한 것 같습니다.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">A</span> 널널<span style="color: red;">A</span>
						강의<span style="color: red;">A</span>
						<span style="color: green;">(추천: 35)</span>
					</div>
